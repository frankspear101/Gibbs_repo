...
! $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
! $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	Subroutine AFMTangent(logFileOn,iGrid,ierr)
    	use AWE_Interfaces
	use MyCanvas
...
!	Open file with BR analyses
	call FSS_Alert('Alert','Open file with AFM BR analyses')
	open(55,FILE='',status = 'UNKNOWN')

!-----------------------------------------------
	! pick the initial assemblage
	numCurrent = 5
	do i = 1,numCurrent
		asmCurrent(i) = i		! this starts with the first 5 phases in the MIF -- may need to be modified	
		end do
	write(95,*)' Starting TP loop'
	write(*,*)' Starting TP loop'
	write(95,401)TC,PB4old,(asmCurrent(k),k=1,numCurrent)			! log file
401	format(2F12.2,20I5)
	...
	do 400 iTP = 2,numPTpoints		! Loop through the entire PT grid
...
!	So, if compositions are off for some reason, the code fails due to the activity calculation (not the uzero calculation)
	...
	rewind(55)
	read(55,*)		! this reads the first line

!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
!	Loop to modify the bulk composition starts here
409	continue
	read(55,*,END=411)(molesStart(i),i=1,6)		! read to the end of file, then we're finished with this TP
	do i = 1,6
		bulkCompMoles(i) = molesStart(i) 				!molesStart is the bulk comp we want to fit in C2ompute
		end do
	write(95,405)(molesStart(i),i=1,6)
405	format(12F12.3)
	countTheMisses = 0
...
! 		endif
	...
	go to 409		! get the next bulk composition in the file

411	continue		! go here on EOF in BR file
